...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Update PROJECT
						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">Update Project</h4>
									<i class="mdi mdi-dots-horizontal text-gray"></i>
								</div>
							</div>
							<div class="card-body">
                                <div class="table-responsive">
                                    <form action="{{url('update/project')}}/{{$data->id}}" method="post" autocomplete="off">
                                        {{method_field('post')}}
                                        {{csrf_field()}}
                                        <div class="form-group">
                                            <input type="hidden" name="title" id="title" >
                                            <label for="recipient-name" class="col-form-label">Title</label>
                                            <input class="form-control" name="title" id="title" value="{{$data->title}}" type="text">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="col">
                                            ...
                                            <input class="form-control fc-datepicker" name="deadline" placeholder="YYYY-MM-DD"
                                                type="text" value="{{$data->deadline}}" required>
                                        </div>
